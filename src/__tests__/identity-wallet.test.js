...
const verifyJWTOpts = { resolver: didResolver }
...
describe('IdentityWallet', () => {
  ...
  it('signClaim creates JWTs correctly', async () => {
    ...
    expect(await verifyJWT(jwt0, verifyJWTOpts)).toBeDefined()
    expect(await verifyJWT(jwt1, verifyJWTOpts)).toBeDefined()
    expect(await verifyJWT(jwt2, verifyJWTOpts)).toBeDefined()
  })
